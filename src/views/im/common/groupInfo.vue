  ...
  <div>
    ...
    <div style="background: var(--midWhite); height: calc(100% - 60px)">
      ...
      <div class="myCenter sendMsg">
        <n-button type="info" @click="sendGroupMessage()"> 发消息 </n-button>
        <template
          v-if="
            groups[currentGroupId].groupType === 1 ||
            (groups[currentGroupId].groupType === 2 &&
              groups[currentGroupId].masterFlag)
          "
        >
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <n-button type="primary" @click="groupSetting()"> 群设置 </n-button>
        </template>
      </div>
    </div>
          ...
          <n-tab-pane name="群设置" tab="群设置">
            <div>
              ...
              >
                <n-button
                  type="warning"
                  @click="exitGroup(currentGroupId)"
            ...
            >
              ...
              <div style="display: flex; align-items: center">
                ...
                <div
                  v-if="
                    !item.adminFlag &&
                    groups[currentGroupId].adminFlag &&
                    item.userStatus === 1
                  "
                  class="user-tag"
...
export default {
  ...
  setup(props, context) {
    ...
    function getGroupUser(groupId, current = 1, size = 9999) {
      $http
        .get($constant.baseURL + '/imChatGroupUser/getGroupUser', {
          groupId: groupId,
          current: current,
          size: size,
        })
