<template>
  <div>
    ...
    <div class="msg-container">
      <template v-if="!$common.isEmpty(currentChatFriendId)">
        <div
          v-for="(item, index) in imMessages[currentChatFriendId]"
          :class="[
            'msg-one',
      ...
      <template v-else-if="!$common.isEmpty(currentChatGroupId)">
        <div
          v-for="(item, index) in groupMessages[currentChatGroupId]"
          :class="[
            'msg-one',
            item.fromId === $store.state.currentUser.id
              ? 'message-right'
    ...
    <div style="height: 180px">
      ...
      <div style="padding: 10px 15px; display: flex; height: 25px">
        ...
        <div class="myEmoji" @click="sendPicture()">
          <svg viewBox="0 0 1024 1024" width="25" height="25">
            ...
            ></path>
            <path
              d="M736.34 428.748V316.902H288.958v447.382H736.34z"
              fill="#231F20"
            ></path>
            <path
            ...
            ></path>
            <path
              d="M288.958 680.4H736.34v55.923H288.958z"
              fill="#FFFFFF"
            ></path>
            <path
          ...
          <template #trigger>
            <div class="myEmoji">
              <svg viewBox="0 0 1024 1024" width="25" height="25">
                ...
                ></path>
                <path
                  d="M428.8 630.72c42.453333-11.84-12.586667 43.2 0 0z"
                  fill="#FFFFF8"
                ></path>
              </svg>
            </div>
          ...
          <template #trigger>
            <div class="myEmoji">
              <svg viewBox="0 0 1024 1024" width="25" height="25">
                ...
                ></path>
                <path
                  d="M697 579.1m-54.5 0a54.5 54.5 0 1 0 109 0 54.5 54.5 0 1 0-109 0Z"
                  fill="#7F0518"
                ></path>
                <path
                  d="M683.3 568m-25.1 0a25.1 25.1 0 1 0 50.2 0 25.1 25.1 0 1 0-50.2 0Z"
                  fill="#FFFFFF"
                ></path>
                <path
                  d="M715.4 604.6m-11.5 0a11.5 11.5 0 1 0 23 0 11.5 11.5 0 1 0-23 0Z"
                  fill="#FFFFFF"
                ></path>
                <path
                  d="M329 579.1m-54.5 0a54.5 54.5 0 1 0 109 0 54.5 54.5 0 1 0-109 0Z"
                  fill="#7F0518"
                ></path>
                <path
                  d="M315.3 568m-25.1 0a25.1 25.1 0 1 0 50.2 0 25.1 25.1 0 1 0-50.2 0Z"
                  fill="#FFFFFF"
                ></path>
                <path
                  d="M347.5 604.6m-11.5 0a11.5 11.5 0 1 0 23 0 11.5 11.5 0 1 0-23 0Z"
                  fill="#FFFFFF"
                ></path>
                <path
      ...
      <div class="message-send">
        <span
          style="color: var(--greyFont); margin-right: 15px; font-size: 12px"
          >Ctrl+Enter：换行 | Enter：发送</span
        >
        <n-button @click="doSend()" type="info"> 发送 </n-button>
      </div>
    </div>
