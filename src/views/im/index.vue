        ...
        <div class="friend-box" v-if="!common.isEmpty(store.state.currentUser)">
            <div class="friend-aside">
                <div>
                    <!-- 头像 -->
                    <div>
                        <el-avatar lazy shape="square" object-fit="cover" @click="changeAvatar(1)" class="user-thumb"
            ...
            <div class="friend-bode" id="body-group">
                <div class="body-left" v-show="showBodyLeft">
                    ...
                    <div style="display: flex; flex-direction: row; align-items: center">
                        <el-input v-model="showFriendValue" placeholder="搜索" class="custom-input">
                            <template #prefix>
                                <el-icon>
                                    <Search />
                                </el-icon>
                        ...
                        <div>
                            <el-dropdown trigger="click">
                                <div class="icon-wrapper">
                                    <svg t="1719670900014" class="icon" fill="none" viewBox="0 0 1024 1024"
                                        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2675" width="20"
                                        height="20">
                                        <path
                                            ...
                                            fill="#444444" p-id="2676"></path>
                                    </svg>
                                </div>
                                <template #dropdown>
                                    <el-dropdown-menu popper-class="add-info">
                                        <el-dropdown-item v-for="(item, index) in state.options" :key="index">{{
                    ...
                    <div class="aside-list" v-show="type === 1">
                        ...
                        <div class="im-user im-active" @click="isActive($event, 'im-active', null, 1)">
                            ...
                            <div class="im-user-right">
                                <div>系统消息</div>
                                <div class="im-down" v-if="!common.isEmpty(systemMessages)">
                                    {{ systemMessages[systemMessages.length - 1].content.substr(0, 8) }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="side-class" style="height: calc(100% - 70px)">
                            ...
                            <div class="im-user im-group-current" v-for="(item, index) in groupChats" :key="index"
                                ...
                                <div>
                                    <el-badge :show-zero="false" :value="groupMessageBadge[item]" :max="99">
                                        <el-avatar object-fit="cover" lazy :size="40" :src="groups[item].avatar" />
                                    </el-badge>
                                </div>
                                <div class="im-user-right">
                            ...
                            <!-- 聊天 -->
                            <div class="im-user im-user-current" v-for="(item, index) in imChats" :key="index" v-show="friends[item].remark.includes(showFriendValue) ||
                                common.isEmpty(showFriendValue)
                                " @click="isActive($event, 'im-active', null, 2, item, 2)">
                                <div>
                                    <el-badge :show-zero="false" :value="imMessageBadge[item]">
                                        <el-avatar object-fit="cover" lazy :size="40" :src="friends[item].avatar" />
                                    </el-badge>
                                </div>
                                <div class="im-user-right">
                    ...
                    <div class="aside-list" v-show="type === 2">
                        ...
                        <div style="margin: 0 30px 0 30px">
                            <el-divider dashed class="divider">
                        ...
                        <div style="height: calc(100% - 180px)" class="side-class">
                            <div class="im-user" v-for="(item, index) in Object.values(friends).reverse()" :key="index"
                                ...
                                <div>
                                    <el-avatar object-fit="cover" lazy style="cursor: pointer"
                                        @click.stop="openFriendCircle(item.friendId, item.avatar)" :size="40"
                                        :src="item.avatar" />
                                </div>
                                <div class="im-friend">
                                    {{ item.remark }}
                    ...
                    <div class="aside-list" v-show="type === 3">
                        ...
                        <div class="im-user-group" v-for="(item, index) in Object.values(groups).reverse()" :key="index"
                            v-show="item.groupName.includes(showFriendValue) ||
                                common.isEmpty(showFriendValue)
                                " @click="isActive($event, 'im-group', null, 5, item)">
                            <div>
                                <el-avatar object-fit="cover" :size="45" lazy :src="item.avatar" />
                            </div>
                            <div class="im-user-right">
                ...
                <!-- 聊天 -->
                <Chat class="body-right" v-if="
                    subType === 2 &&
                    (!common.isEmpty(currentChatFriendId) ||
                        !common.isEmpty(currentChatGroupId))
                " :currentChatFriendId="currentChatFriendId" :currentChatGroupId="currentChatGroupId"
                    :friends="friends" :groups="groups" :imageList="imageList" :imMessages="imMessages"
                    :groupMessages="groupMessages" @sendMsg="sendMsg" @openFriendCircle="openFriendCircle"></Chat>
                ...
                <div class="body-right" v-if="subType === 3">
                    ...
                    <div class="friend-request">
                        <div style="margin: 20px; display: flex" v-for="(item, index) in friendRequests" :key="index">
                            <!-- 图标 -->
                            <div>
                                <el-avatar object-fit="cover" :size="50" lazy :src="item.avatar" />
                            </div>
                            ...
                            <div style="display: flex; flex: 1">
                                ...
                                <div class="request-status">
                                    <el-button @click="changeFriendStatus(item.friendId, 1, index)" size="small"
                ...
                <div class="body-right" v-if="subType === 4 && !common.isEmpty(currentFriendId)">
                    ...
                    <div style="background: var(--midWhite); height: calc(100% - 60px)">
                        <div class="myCenter">
                            <div class="friend-info">
                                <div style="display: flex; align-items: center">
                                    <el-avatar object-fit="cover" :size="60" lazy
                                ...
                                <div style="margin-top: 4px; cursor: pointer;color: var(--red);"
                                    @click="removeFriend(currentFriendId)">
                                    <div class="myCenter">
                                        <el-icon size="14" style="margin-bottom: 1.5px;">
                                            <Delete />
                                        </el-icon>
                                        <div style="font-size: 14px;">删除好友</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="myCenter">
                            <div style="width: 65%; font-size: 16px">
                                ...
                                <div>
                                    ...
                                    <span>{{
                                        common.isEmpty(friends[currentFriendId].introduction)
                                            ? '暂无简介'
                                            : friends[currentFriendId].introduction
                                    }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="myCenter sendMsg">
                            <el-button @click="sendFriendMessage()" type="success">
                                发消息
                            </el-button>
                        </div>
                    </div>
                ...
                <!-- 头像修改弹出框 -->
                <el-dialog draggable title="修改图片" v-model="showAvatarDialog" width="30%" :append-to-body="true"
                    destroy-on-close center top="25vh">
                    <div>
                        <UploadPicture :prefix="'commentPicture'" @addPicture="submitAvatar" :maxSize="2"
                            :maxNumber="1">
                        </UploadPicture>
                    </div>
                </el-dialog>
                ...
                <!-- 修改信息 -->
                <el-dialog draggable title="修改信息" v-model="changeModal" width="30%" :append-to-body="true"
                    destroy-on-close center top="35vh">
                    <div>
                        <el-input v-model="changeDataInfo" maxlength="30" show-count clearable />
                    </div>
                    <div class="myCenter" style="margin-top: 30px">
                        <el-button @click="submitChange()" type="primary"> 提交 </el-button>
                    </div>
                </el-dialog>

                <!-- 朋友圈 -->
                <el-dialog draggable class="friend-model" style="min-width: 820px;" v-model="showFriendCircle"
                    :append-to-body="true" :close-on-click-modal="false" destroy-on-close :show-close="false" center
                    top="3vh">
                    <div style="background-color: var(--background);border-radius: 10px">
                        ...
                        <div class="pagination-wrap">
                            ...
                            <ProButton :info="'随笔'" style="margin-left: 20px"
                                v-if="store.state.currentUser.id === pagination.userId" @click="launch()"
                                :before="constant.before_color_2" :after="constant.after_color_2">
                            </ProButton>
                            <ProButton :info="'加好友'" style="margin-left: 20px"
                                v-else-if="common.isEmpty(friends[pagination.userId])" @click="addFriend()"
                                :before="constant.before_color_2" :after="constant.after_color_2">
                            </ProButton>
                        </div>
                    </div>
                ...
                <el-dialog draggable title="朋友圈" v-model="weiYanDialogVisible" width="40%" :append-to-body="true"
                    destroy-on-close :close-on-click-modal="false" center top="25vh">
                    <div>
...
const {
    friendCircleData, launch, openFriendCircle, deleteTreeHole, submitWeiYan, pageWeiYan, cleanFriendCircle, addFriend
} = friendCircle();
...
const state = reactive({
    options: [
        ...
        {
            label: '添加群聊',
            key: 'add_friend_group',
        },
        {
            label: '创建群聊',
            key: 'create_friend_group',
        },
    ],
})
...
const getIm = () => {
    ...
    im.tio.ws.onmessage = (event) => {
        ...
        if (message.messageType === 1) {
            ...
            groupData.groups[message.groupId] !== null &&
            groupData.groups[message.groupId] !== undefined
        ) {
            if (
                data.groupMessages[message.groupId] === null ||
                data.groupMessages[message.groupId] === undefined
            ) {
            ...
            if (
                (data.subType !== 2 ||
                    data.currentChatGroupId !== message.groupId) &&
                message.fromId !== store.state.currentUser.id
            ) {
                if (
                    data.groupMessageBadge[message.groupId] === null ||
                    data.groupMessageBadge[message.groupId] === undefined
                ) {
                    data.groupMessageBadge[message.groupId] = 1
                } else {
                    data.groupMessageBadge[message.groupId] =
                        data.groupMessageBadge[message.groupId] + 1
                }
            }
...
const getMessages = (friendId, current = 1, size = 100) => {
...
const getGroupMessages = (groupId, current = 1, size = 100) => {
...
const { emailVisible, email, code, password, codeString } = toRefs(bindEmailData)
const { changeDataInfo, changeType, changeModal, avatarType, avatarPrefix, showAvatarDialog } = toRefs(changeDataData)
const { showFriendCircle, treeHoleList, weiYanDialogVisible, isPublic, weiYanAvatar, weiYanUsername, pagination } = toRefs(friendCircleData);
const { friendRequests, friends, currentFriendId } = toRefs(friendData);
const { groups, currentGroupId } = toRefs(groupData);
const { systemMessages, showBodyLeft, imageList } = toRefs(imUtilData);
const { imMessageBadge, imMessages, imChats, currentChatFriendId, groupMessages, groupMessageBadge, groupChats,
    currentChatGroupId, type, subType, showFriendValue } = toRefs(data)
...
.treeHole-wrap {
    ...
    &::-webkit-scrollbar {
        display: none;
        /* 这在某些浏览器版本中可能不起作用，因为display: none不是::-webkit-scrollbar的合法值 */
        width: 0;
        /* 更常见且有效的方法是将宽度设置为0 */
    }
}
