      ...
      <div class="friend-bode" id="body-group">
        <div class="body-left" v-show="showBodyLeft">
          ...
          <div class="aside-list" v-show="type === 1">
            <!-- 系统消息 -->
            <div
              class="im-user im-active"
              @click="isActive($event, 'im-active', null, 1)"
            >
              <div>
              ...
              <div class="im-user-right">
                ...
                <div class="im-down" v-if="!$common.isEmpty(systemMessages)">
                  {{
                    systemMessages[systemMessages.length - 1].content.substr(
                      0,
                      8
                    )
                  }}
            ...
            <div style="overflow-y: scroll; height: calc(100% - 70px)">
              ...
              <div
                ...
                :key="index"
                v-show="
                  groups[item].groupName.includes(showFriendValue) ||
              ...
              >
                ...
                <div class="im-user-right">
                  ...
                  <div
                    class="im-down"
                    v-if="!$common.isEmpty(groupMessages[item])"
                  >
                    {{
                      groupMessages[item][
              ...
              <div
                ...
                :key="index"
                v-show="
                  friends[item].remark.includes(showFriendValue) ||
                  $common.isEmpty(showFriendValue)
                "
              ...
              >
                ...
                <div class="im-user-right">
                  ...
                  <div
                    class="im-down"
                    v-if="!$common.isEmpty(imMessages[item])"
                  >
                    {{
                      imMessages[item][
          ...
          <div class="aside-list" v-show="type === 2">
            <!-- 添加好友 -->
            <div
              class="im-user friend-active"
              @click="isActive($event, 'friend-active', null, 3)"
            >
              <div>
                <svg viewBox="0 0 1024 1024" width="40" height="40">
                  <path
                  ...
                  ></path>
                  <path
                    d="M680.9984 587.776v165.5552h-38.4V587.776z"
                    fill="#FFFFFF"
                  ></path>
                </svg>
              </div>
            ...
            <div style="overflow-y: scroll; height: calc(100% - 140px)">
              <div
                ...
                :key="index"
                v-show="
                  item.remark.includes(showFriendValue) ||
                  $common.isEmpty(showFriendValue)
                "
          ...
          <div class="aside-list" v-show="type === 3">
            ...
            <div
              ...
              :key="index"
              v-show="
                item.groupName.includes(showFriendValue) ||
                $common.isEmpty(showFriendValue)
              "
            ...
            >
              ...
              <div class="im-user-right">
                ...
                <div class="im-down">
                  <span
                    class="group-tag"
                    v-if="item.masterFlag || item.adminFlag"
                  >
        ...
        <!-- 发朋友动态 -->
        <n-modal
          v-model:show="weiYanDialogVisible"
          :mask-closable="false"
          preset="dialog"
        >
...
import { useDialog, NDropdown, NButton, NIcon, NInput } from 'naive-ui'
...
export default {
  ...
  setup(props, context) {
    ...
    const { groupData, getImGroup, addGroupTopic, exitGroup, dissolveGroup } =
      group()
    const {
      imUtilData,
      changeAside,
