    ...
    <div>
        ...
        <div style="background: var(--midWhite); height: calc(100% - 60px)">
            ...
            <div class="myCenter" style="padding: 50px 0">
                <el-avatar object-fit="cover" shape="square" :size="60" lazy :src="groups[currentGroupId].avatar" />
            </div>
            ...
            <div class="myCenter">
                <div style="width: 65%; font-size: 16px">
                    ...
                    <div style="margin-bottom: 10px">
                        ...
                        <span @click="changeDataType(2)" v-if="groups[currentGroupId].masterFlag"
                    ...
                    <div style="margin-bottom: 10px">
                        ...
                        <span @click="changeDataType(3)" v-if="groups[currentGroupId].masterFlag"
                            style="display: inline-block;vertical-align: sub;cursor: pointer;">
                            <svg viewBox="0 0 1024 1024" width="20" height="20">
                                <path
                                    d="M929.909189 827.019236H93.990821c-16.598379 0-29.997071 13.398692-29.99707 29.997071s13.398692 29.997071 29.99707 29.997071h835.918368c16.598379 0 29.997071-13.398692 29.99707-29.997071 0-16.498389-13.398692-29.997071-29.99707-29.997071z"
                    ...
                    <div style="margin-bottom: 40px">
                        ...
                        <span @click="changeDataType(4)" v-if="groups[currentGroupId].masterFlag"
                            style="display: inline-block;vertical-align: sub;cursor: pointer;">
                            <svg viewBox="0 0 1024 1024" width="20" height="20">
                                <path
                                    d="M929.909189 827.019236H93.990821c-16.598379 0-29.997071 13.398692-29.99707 29.997071s13.398692 29.997071 29.99707 29.997071h835.918368c16.598379 0 29.997071-13.398692 29.99707-29.997071 0-16.498389-13.398692-29.997071-29.99707-29.997071z"
            ...
            <div class="myCenter sendMsg">
                <el-button type="success" @click="sendGroupMessage()"> 发消息 </el-button>
                <template v-if="groups[currentGroupId].groupType === 1 || (groups[currentGroupId].groupType === 2 &&
                        groups[currentGroupId].masterFlag)">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <!-- 群设置 -->
        <el-drawer v-model="activeGroupSet" :with-header="false" append-to="#body-group">
            <el-tabs v-model="tabName" class="demo-tabs">
                <el-tab-pane label="群设置" name="群设置">
                    <div>
                        <div class="myCenter" style="margin: 15px 0">
                            <el-avatar lazy object-fit="cover" @click="changeAvatar(2)" round class="group-avatar"
                                :size="70" :src="groups[currentGroupId].avatar" />
                        </div>

                        <div class="group-set" v-if="groups[currentGroupId].groupType === 1 &&groups[currentGroupId].masterFlag">
                            <div>是否需要审核</div>
                            <div>
                                <el-switch v-model="groups[currentGroupId].inType" @update:value="updateInType(currentGroupId,!groups[currentGroupId].inType)" class="ml-2" style="--el-switch-on-color: #13ce66; --el-switch-off-color: #ff4949; margin-right: 30px"/>
                            </div>
                        </div>

                        <div style="display: flex;justify-content: space-around;margin-top: 20px;">
                            <el-button type="warning" @click="exitGroup(currentGroupId)"
                                v-if="groups[currentGroupId].groupType === 1" style="margin-left: 20px;">
                                退出群
                            </el-button>

                            <template v-if="groups[currentGroupId].masterFlag">
                                <el-button type="danger" @click="dissolveGroup(currentGroupId)" style="margin-right: 20px;">
                                    解散群
                                </el-button>
                            </template>
                        </div>
                ...
                <el-tab-pane label="群成员" name="群成员" v-if="groups[currentGroupId].groupType === 1">
                    <div class="group-user" v-for="(item, index) in groupUsers" :key="index">
                        <!-- 成员信息 -->
                        <div style="display: flex; align-items: center">
                            <div>
                                <el-avatar shape="square" object-fit="cover" :size="40" lazy :src="item.avatar" />
                            </div>
...
const emit = defineEmits(['changeDataType', 'sendGroupMessage', 'exitGroup', 'changeAvatar', 'dissolveGroup'])
...
const updateInType = (currentGroupId, inType) => {
...
const getGroupUser = (groupId, current = 1, size = 9999) => {
    http.get(constant.baseURL + '/imChatGroupUser/getGroupUser', {
        groupId: groupId,
        current: current,
        size: size,
    })
...
const exitGroup = (currentGroupId) => {
    emit('exitGroup', currentGroupId)
}

const dissolveGroup = (currentGroupId) => {
    emit('dissolveGroup', currentGroupId)
}

const changeGroupUserStatus = (groupId, item, oldUserStatus, userStatus) => {
...
const { groupUsers, activeGroupSet, tabName } = toRefs(data)
